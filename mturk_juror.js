...
var trial_string = `https://inversepictionary.github.io/mt_juror.html?trial_id=0&user_id=${user_id}`;
var practice_string = `https://inversepictionary.github.io/mt_juror.html?trial_id=0&user_id=${user_id}`;
